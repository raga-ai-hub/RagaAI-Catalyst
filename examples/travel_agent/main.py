...
@tracer.trace_agent(name="travel_agent", agent_type="main")
def travel_agent():
        tracer.span("travel_agent").add_metrics(
...
if __name__ == "__main__":
    ...
    with tracer:
        ...
        with tracer.span("trace_level_metrics") as span:
            span.add_metrics(
                name="Q/A_trace-level",
                score=0.3,
                reasoning="Overall trace metrics",
                cost=0.0003,
                latency=0.002
            )
            ...
            span.add_metrics(
                name="Q/A_trace-level",
                score=0.3,
                reasoning="Additional trace metrics",
                cost=0.0003,
                latency=0.002
            )

            span.add_metrics(
                name="Q/A_trace-level1",
                score=0.3,
                reasoning="Final trace metrics",
                cost=0.0003,
                latency=0.002
            )
