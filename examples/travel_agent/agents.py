...
from config import initialize_catalyst, initialize_tracer
...
class ItineraryAgent:
    ...
    @tracer.trace_agent(name="plan_itinerary", agent_type="travel_planner")
    def plan_itinerary(self, user_preferences, duration=3):
        with tracer.span("plan_itinerary") as span:
            span.add_metrics(
